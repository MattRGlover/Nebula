...
// Transition settings - full cycle (DYNAMIC VERSION - ultra-smooth pace)
const BLACK_DURATION = 20000;      // 20 seconds at black (more time to appreciate)
const TO_WHITE_DURATION = 10000;   // 10 seconds transitioning to white (very smooth)
const WHITE_DURATION = 15000;      // 15 seconds at white (more time to appreciate)
      ...
      if (i === 0) {
        ...
        for (let attempt = 0; attempt < maxAttempts; attempt++) {
          ...
          for (const s of placedSplotches) {
            ...
            // Complementary colors get HUGE separation to prevent muddy mixing in MULTIPLY mode
            const sepFactor = sameHue ? 0.9 : complementary ? 1.2 : 0.65;
